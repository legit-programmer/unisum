...
**NOTE: Gitpod uses linux servers, therefore image summarization will not work as it uses tesseract ocr which currently is configured only for windows for this project.**
